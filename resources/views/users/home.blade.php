        ...
        <div class="col-8">
            ...
            @empty
                ...
                <div class="text-center">
                    <h2>Share Photos</h2>
                    <p class="text-muted">When you share photos, they'll appear on yor profile.</p>
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-auto">
                                <form action="{{ route('follow.store', $user->id) }}" method="post">
                                    @csrf
                                    <button class="border-0 bg-transparent p-0 text-primary btn-sm" type="submit">Follow</button>
                                </form>
                            </div>
                        </div>
                    @endforeach
